...
import { Dumbbell, Library, Play, FolderOpen } from 'lucide-react';
        ...
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="bg-emerald-500 hover:bg-emerald-600 text-white px-4 py-2 rounded-lg font-medium flex items-center gap-2 transition-colors active:scale-95"
            >
